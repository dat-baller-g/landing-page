...
const HeroIllustration = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-indigo-700 to-blue-400">
    <div  >

        <div ref={(el) => (scrollRevealRef.current[2] = el)}>
          <img src={phone} className="w-48 right-56 z-50 rotate-12 absolute" alt="hero" id='phone'/>
        </div>
      ...
      >
       ...
       <div
        ...
        className="hero-illustration-browser drop-shadow-2xl overflow-hidden relative" id="hero-white-background"
      >
      {/* <img src="../data/phone.png" className="w-40 z-50" /> */}
        <svg        
          className="ml-auto max-w-screen-sm lg:max-w-none z-10 "
          width="800"
          height="400"
          viewBox="0 0 800 450"
          xmlns="http://www.w3.org/2000/svg"
        >
          ...
          <g fill="none" fillRule="evenodd">
            ...
            {/* <img src="../data/phone.png" className='w-40'/> */}
            <g strokeWidth="2">
              <path
     ...
     {/* big circle */}
      <div
        ...
        className=" relative  drop-shadow-2xl lg:block z-5" id="big-circle"
      >
        <svg
          width="400"
          height="400"
      ...
      {/* <div
        ...
        className="hero-ball hero-ball-2  drop-shadow-2xl relative -top-96"
      >
        <svg
          width="100"
          height="200"
      ...
      <div
        ...
        className="hero-ball hero-ball-3 relate drop-shadow-2xl"
      ...
      {/* <div
        ...
        className="hero-ball hero-ball-4"
      >   
...
{/*     
      ...
      <div
        ...
        className="hero-ball hero-ball-5 relative top-0"
      >
